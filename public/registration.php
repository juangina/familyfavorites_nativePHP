...
///////////////////////////////Create mail object
              ...
              $sql = "SELECT * FROM smtp_accounts WHERE hostname = 'mailgun'";
              ...
              $mail->Password = $row["smtp_pwd"];
              $mail->SMTPSecure = $row["security"];
              $mail->Port     = $row["port"];
              //Set Mail Object Parameters
              ...
              // Set Email subject
              $mail->Subject = 'Family Favorite Registration';
              // Set email format to HTML
              $mail->isHTML(true);
              // Set Email body content
              $mailContent = '<h2>Family Favorites</h2><p>Thank you for registering with Family Favorite App</p><p>I hope you will Enjoy the App</p>';
  ...
  <div class="container">
    ...
    <form method="post">
      <div class="form-group">
        <input type="text" name="name" class="form-control" placeholder="User Name" value="<?php echo $_POST['name']; ?>" />
